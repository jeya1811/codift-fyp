...
define dso_local i32 @main() #0 {
  ...
  %27 = call i32 @ramReadFunc(ptr @ramReadFunc)
  call void @secExcFunc(i32 %27)
  %28 = call i32 @ramReadFunc(ptr noundef %4)
  store i32 %28, ptr %codift_inject_temp5, align 4
  %29 = call i32 @ramReadFunc(ptr %codift_inject_temp5)
  call void @ramWriteFunc(ptr %5, i32 %29)
  store i32 %28, ptr %5, align 4
  %30 = call i32 @ramReadFunc(ptr %5)
  call void @ramWriteFunc(ptr %codift_inject_temp6, i32 %30)
  %31 = load i32, ptr %5, align 4
  store i32 %31, ptr %codift_inject_temp7, align 4
  %32 = call i32 @ramReadFunc(ptr %codift_inject_temp7)
  call void @ramWriteFunc(ptr %codift_inject_temp6, i32 %32)
  store i32 %31, ptr %codift_inject_temp6, align 4
  %33 = call i32 @ramReadFunc(ptr @printf)
  call void @secExcFunc(i32 %33)
  %34 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %31)
  %35 = call i32 @ramReadFunc(ptr %5)
  call void @ramWriteFunc(ptr %codift_inject_temp8, i32 %35)
  %36 = load i32, ptr %5, align 4
  store i32 %36, ptr %codift_inject_temp9, align 4
  %37 = call i32 @ramReadFunc(ptr %codift_inject_temp9)
  call void @ramWriteFunc(ptr %codift_inject_temp8, i32 %37)
  store i32 %36, ptr %codift_inject_temp8, align 4
  %38 = call i32 @ramReadFunc(ptr @secExcFunc)
  call void @secExcFunc(i32 %38)
  call void @secExcFunc(i32 noundef %36)
  ret i32 0
}
