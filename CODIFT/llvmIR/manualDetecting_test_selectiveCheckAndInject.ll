; ModuleID = 'llvmIR/manualDetecting_test.ll'
source_filename = "src/code/manualDetecting_test.c"
...
define dso_local i32 @main() #0 {
  ...
  %24 = call i32 @ramReadFunc(ptr @codift_taint_region)
  call void @secExcFunc(i32 %24)
  call void @codift_taint_region(ptr noundef %4, i64 noundef 4)
  %25 = call i32 @ramReadFunc(ptr @ramReadFunc)
  call void @secExcFunc(i32 %25)
  %26 = call i32 @ramReadFunc(ptr noundef %4)
  store i32 %26, ptr %5, align 4
  %27 = call i32 @ramReadFunc(ptr %5)
  call void @ramWriteFunc(ptr %codift_inject_temp4, i32 %27)
  %28 = load i32, ptr %5, align 4
  store i32 %28, ptr %codift_inject_temp5, align 4
  %29 = call i32 @ramReadFunc(ptr %codift_inject_temp5)
  call void @ramWriteFunc(ptr %codift_inject_temp4, i32 %29)
  store i32 %28, ptr %codift_inject_temp4, align 4
  %30 = call i32 @ramReadFunc(ptr @printf)
  call void @secExcFunc(i32 %30)
  %31 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %28)
  %32 = call i32 @ramReadFunc(ptr %5)
  call void @ramWriteFunc(ptr %codift_inject_temp6, i32 %32)
  %33 = load i32, ptr %5, align 4
  store i32 %33, ptr %codift_inject_temp7, align 4
  %34 = call i32 @ramReadFunc(ptr %codift_inject_temp7)
  call void @ramWriteFunc(ptr %codift_inject_temp6, i32 %34)
  store i32 %33, ptr %codift_inject_temp6, align 4
  %35 = call i32 @ramReadFunc(ptr @secExcFunc)
  call void @secExcFunc(i32 %35)
  call void @secExcFunc(i32 noundef %33)
  ret i32 0
}
...
declare void @codift_taint_region(ptr noundef, i64 noundef) #1
