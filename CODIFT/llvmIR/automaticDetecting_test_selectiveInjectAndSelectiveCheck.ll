...
define dso_local i32 @main() #0 {
  ...
  %18 = call i32 @ramReadFunc(ptr noundef %4)
  store i32 %18, ptr %5, align 4
  %19 = call i32 @ramReadFunc(ptr %5)
  call void @ramWriteFunc(ptr %codift_inject_temp4, i32 %19)
  %20 = load i32, ptr %5, align 4
  store i32 %20, ptr %codift_inject_temp5, align 4
  %21 = call i32 @ramReadFunc(ptr %codift_inject_temp5)
  call void @ramWriteFunc(ptr %codift_inject_temp4, i32 %21)
  store i32 %20, ptr %codift_inject_temp4, align 4
  %22 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %20)
  %23 = call i32 @ramReadFunc(ptr %5)
  call void @ramWriteFunc(ptr %codift_inject_temp6, i32 %23)
  %24 = load i32, ptr %5, align 4
  store i32 %24, ptr %codift_inject_temp7, align 4
  %25 = call i32 @ramReadFunc(ptr %codift_inject_temp7)
  call void @ramWriteFunc(ptr %codift_inject_temp6, i32 %25)
  store i32 %24, ptr %codift_inject_temp6, align 4
  call void @secExcFunc(i32 noundef %24)
  ret i32 0
}
